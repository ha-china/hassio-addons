...
![支持捐赠](https://img.shields.io/badge/Buy%20me%20a%20coffee%20(no%20paypal)-%23d32f2f?logo=buy-me-a-coffee&style=flat&logoColor=white) ![支持捐赠](https://img.shields.io/badge/Buy%20me%20a%20coffee%20with%20Paypal-0070BA?logo=paypal&style=flat&logoColor=white)
...
![@alexbelgium/hassio-addons的星标仓库列表](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg) ![下载量增长](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/immich_cuda/stats.png)

## 关于

从您的手机直接进行自我托管照片和视频备份解决方案，支持CUDA硬件加速。这是Immich的CUDA支持版本，它为使用NVIDIA GPU进行机器学习任务提供了硬件加速。
...
- **env_vars选项**: 使用插件的`env_vars`选项传递额外的环境变量（名称可以是全大写或全小写）。请参阅[为您的插件添加环境变量](https://github.com/alexbelgium/hassio-addons/wiki/Add-Environment-variables-to-your-Addon-2)以获取详细信息。
