...
这是一个为TOMMY开发的Home Assistant插件，TOMMY是一种Wi-Fi运动检测系统，它可以将ESP32设备变成能够检测墙壁和障碍物中运动的运动传感器。

该插件直接将TOMMY集成到您的Home Assistant实例中，允许您创建用于现有自动化任务的运动区域。所有处理都在您的本地网络上进行。
