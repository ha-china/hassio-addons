...
音乐助手是一款免费的开源音乐库管理器，它可以连接到您的流媒体服务和多种连接的扬声器。将您的Home Assistant实例变成您自己的个人音乐流媒体中心！
...
- 📱 **美丽界面**：现代网络界面，可通过Home Assistant访问
...
启用时，音乐助手将不加载任何提供程序启动。这对于故障排除启动问题或提供程序相关问题很有用。
...
一旦您安装了应用（或网络中的任何音乐助手服务器），Home Assistant应自动检测音乐助手服务器。在设备与服务页面，您应该看到一个用于设置集成的卡片。
