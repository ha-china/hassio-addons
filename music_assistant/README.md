...
音乐助手是一个免费的开源音乐库管理器，可以连接到您的流媒体服务和各种连接的扬声器。将您的Home Assistant实例变成您自己的个人音乐流媒体中心！
...
一旦您安装了应用（或网络中的任何音乐助手服务器），Home Assistant应自动检测音乐助手服务器。在设备和服务页面，您应该会看到一个用于设置集成的卡片。
