...
> 在浏览器中通过 NoVNC 流式传输 Antigravity AI IDE (带有 XFCE4 的 Linux 桌面)。

---

## 📖 关于

如果您在使用此附加组件时遇到任何问题，请使用下面的链接报告它们。问题表单将预填充附加组件信息，以帮助我们更快地解决问题。
...
> [!NOTE]
> 请使用上面的链接报告问题。这确保了所有必要的信息（附加组件名称、版本等）都会自动包含在您的错误报告中。
...
通过 Home Assistant 附加组件页面上的 **Configuration** 选项卡配置附加组件。
