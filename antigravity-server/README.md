...
[![打开您的 Home Assistant 实例并显示插件仪表板。](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=c1e285b7_antigravity-server)
...
> 通过 NoVNC 在您的浏览器中流式传输 Antigravity AI IDE（Linux 桌面版，XFCE4）。
...
如果您有新功能或改进的想法，请使用下面的链接提交功能请求。表单将预先填写插件的详细信息。
