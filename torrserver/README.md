# Home Assistant 的 TorrServer 应用
...
🌟 请考虑通过点击星号来支持 [该项目](https://github.com/aatrubilin/hassio-torrserver)。
...
有问题或疑问？您可以 [在此处打开 Issue](https://github.com/aatrubilin/hassio-torrserver/issues)。

> _请注意，此应用仅与 **HA OS** 一起测试。_

----

此 Hassio 应用由 [@aatrubilin](https://github.com/aatrubilin) 基于 [YouROK/TorrServer](https://github.com/YouROK/TorrServer) 提供。
