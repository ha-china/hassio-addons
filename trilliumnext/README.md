...
* 笔记可以组织成任意深度的树结构。单个笔记可以被放置在树的多个位置（见[克隆笔记](https://triliumnext.github.io/Docs/Wiki/cloning-notes)）
* 富文本 WYSIWYG 笔记编辑，包括表格、图片以及[数学](https://triliumnext.github.io/Docs/Wiki/text-notes)等，支持 markdown [自动格式化](https://triliumnext.github.io/Docs/Wiki/text-notes#autoformat)
...
* 优化触摸的[移动前端](https://triliumnext.github.io/Docs/Wiki/mobile-frontend)适用于智能手机和平板电脑
