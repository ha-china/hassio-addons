...
我利用业余时间维护这个和其他Home Assistant add-ons：跟上上游的变化、HA的变化，并在真实硬件上测试需要大量时间（和一些金钱）。我大约使用我超过110个add-ons中的5-10个，所以我会安装一些我不用来测试和改进add-ons的测试机器（和一些测试服务，如vpn）。
...
_感谢所有star了我的仓库！点击下面的图片来star它，然后它就会在右上角。谢谢！_
