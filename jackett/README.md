...
我在业余时间维护这个和其他 Home Assistant 插件：跟上上游的变化、HA 的变化，并在真实硬件上测试需要大量时间（和一些金钱）。我大约使用我超过 110 个插件中的 5-10 个，所以我安装了一些我自己不使用的测试机器（和一些测试服务，如 VPN）来调试和改进插件。
...
[jackett](https://github.com/jackett/jackett) - 一个用于电影的 jackett 分叉，如 Couchpotato。
