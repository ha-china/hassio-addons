...
我在业余时间维护这个以及其他 Home Assistant 插件：跟踪上游更改、Home Assistant 更改以及在真实硬件上进行测试需要花费很多时间（还有一些钱）。我经常使用我超过 110 个插件中的 5-10 个，所以我安装了测试机器（并购买了某些我本人不使用的测试服务，例如 VPN），以便进行故障排除和改进插件。
...
_感谢每一位为我仓库点星的人！要星标它，请点击下面的图片，然后它就会显示在右上角。谢谢！_
...
[jackett](https://github.com/jackett/jackett) - jackett 的分支，用于与 Couchpotato 等电影一起使用。

此插件基于 [linuxserver.io 的 docker 镜像](https://github.com/linuxserver/docker-jackett)。
