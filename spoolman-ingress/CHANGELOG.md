...
- Bumped HA addon version to: 0.26.1-1-ingress
...
- Bumped HA addon Ingress version to : 0.24.0-0-ingress

## [0.23.1-0-Ingress] - 2026-06-11
- Added Ingress support thanks to @dmuth23
- Spoolman version : 0.23.1
   - Spoolman changelog: https://github.com/Donkie/Spoolman/releases/tag/v0.23.1
