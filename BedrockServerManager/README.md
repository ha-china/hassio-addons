...
Bedrock Server Manager 是一个全面的 Python 服务器，旨在轻松安装、管理和维护 Minecraft 岩石版专用服务器。
...
1. 设置在 /addon_configs/2effc9b9_bedrockservermanager。
1. 在 bedrock-server-manager 的文档中，此文件夹为 /root/。
