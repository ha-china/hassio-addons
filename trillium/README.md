...
* 笔记可以组织成任意深度的树。单个笔记可以放置在树的多个位置（见[克隆笔记](https://github.com/zadam/trilium/wiki/Cloning-notes)）
* 富文本 WYSIWYG 笔记编辑，包括表格、图片以及[数学公式](https://github.com/zadam/trilium/wiki/Text-notes#math-support)和 markdown [自动格式化](https://github.com/zadam/trilium/wiki/Text-notes#autoformat)
* 支持编辑[带有源代码的笔记](https://github.com/zadam/trilium/wiki/Code-notes)，包括语法高亮
* 快速轻松地在笔记之间[导航](https://github.com/zadam/trilium/wiki/Note-navigation)，全文搜索和[笔记提升](https://github.com/zadam/trilium/wiki/Note-hoisting)
...
* 强大的[笔记加密](https://github.com/zadam/trilium/wiki/Protected-notes)，每个笔记可独立加密
...
* [脚本](https://github.com/zadam/trilium/wiki/Scripts) - see [Advanced showcases](https://github.com/zadam/trilium/wiki/Advanced-showcases)
* [REST API](https://github.com/zadam/trilium/wiki/ETAPI) 用于自动化
* 可扩展性良好，在可用性和性能方面均适用于超过 100,000 个笔记
* 优化触摸的[移动前端](https://github.com/zadam/trilium/wiki/Mobile-frontend)适用于智能手机和平板电脑
...
1. 将我的 Hass.io 插件仓库[repository](https://github.com/jdeath/homeassistant-addons)添加到您的 Hass.io 实例中。
1. 安装此插件。
1. 点击“保存”按钮以存储您的配置。
1. 在您的 homeassistant 上创建目录 `/share/trillium/`
1. 通过 ssh 登录您的 home assistant 并运行 `chmod 2777 /share/trillium`
1. 启动插件。
1. 检查插件的日志以查看是否一切顺利。
