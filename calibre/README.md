## ⚠️ Open Issue : [🐛 [Calibre] Waiting for stream... / WebSocket disconnected. Attempting to reconnect... / Connection established. Waiting for server mode... (opened 2025-09-25)](https://github.com/alexbelgium/hassio-addons/issues/2126) by [@codyc1515](https://github.com/codyc1515)
...
[Calibre](https://calibre-ebook.com/) 是一个强大且易于使用的电子书管理器。用户称其为杰出且必备。它几乎可以做到任何事情，并超越了普通的电子书软件。它也是完全免费且开源的，非常适合普通用户和计算机专家。
...
| `PASSWORD` | 字符串 | | 用于 GUI 访问的可选密码 |
| `CLI_ARGS` | 字符串 | | Calibre 的可选 CLI 启动参数 |
