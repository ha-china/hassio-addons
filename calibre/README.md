...
我在业余时间维护这个和其他 Home Assistant 插件：跟踪上游变更、Home Assistant 变更以及在真实硬件上进行测试都需要花费大量时间（以及一些金钱）。我经常使用我 >110 个插件中的 5-10 个，所以我安装了测试机器（并购买了一些我本人不使用的测试服务，如 VPN），以便进行故障排除和改进插件。
...
[Calibre](https://calibre-ebook.com/) 是一个强大且易于使用的电子书管理器。用户称它卓越且必不可少。它几乎可以做任何事情，并且比普通的电子书软件更进一步。它也是完全免费和开源的，非常适合普通用户和电脑专家。

此插件基于 docker 映像 https://github.com/linuxserver/docker-calibre
