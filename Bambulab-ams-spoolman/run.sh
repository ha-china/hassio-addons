...
if [ -f "$OPTIONS_FILE" ]; then
    ...
    SET_LOCATION=$(jq -r '.SET_LOCATION // false' "$OPTIONS_FILE")
...
export PRINTER_ID PRINTER_CODE PRINTER_IP SPOOLMAN_ENDPOINT UPDATE_INTERVAL SET_LOCATION NEVER_MERGE_IF_TAG DEBUG MODE
