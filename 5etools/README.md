...
一套基于浏览器的工具，适用于 D&D 5e 的玩家和地下城主。从 5etools GitHub 下载发布的图片。jdeath 的存储库中没有托管或发布任何图片或内容。由于 Home Assistant 插件创建者不使用此功能，因此不会提供支持。自托管的图片可能比 5etools 网站上的版本落后一个版本。图片大小为 4 GB，因此安装需要很长时间，请耐心等待。
