...
一套基于浏览器的工具，适用于D&D 5e的玩家和DM。从5etools GitHub下载图像。没有图像或内容在jdeath的仓库中托管/发布。不提供支持，因为Home Assistant Addon创建者不使用这个。自托管图像可能落后于5etools网站。图像是4 GB，所以安装时间会很长，请耐心等待。
...
这个插件的安装非常简单，与其他任何Hass.io插件的安装方式没有不同。
