...
一套基于浏览器的工具，适用于 D&D 5e 的玩家和地下城主。从 5etools GitHub 下载上传的图片。jdeath 的仓库中不托管或发布任何图片或内容。由于 Home Assistant 插件创建者不使用此功能，因此不提供支持。自托管的图片可能与 5etools 网站上的版本存在差异。图片大小为 4 GB，因此安装需要较长时间，请耐心等待。
