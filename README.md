...
# 🔔 Home Assistant 应用库 
> [`Github 仓库`](https://github.com/ha-china/hassio-addons)只是为了方便自动更新，要使用的话请用 `Gitee同步镜像站` [![添加应用到 Home Assistant](https://img.shields.io/badge/add_addon_repository-MY%20HA-41BDF5?style=for-the-badge&logo=home-assistant&logoColor=white)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https://gitee.com/desmond_GT/hassio-addons) 🚀

🎉 **欢迎来到 Home Assistant 应用库！** 在这里，您将发现众多自定义应用，✨  

🔧 **部分应用是我自己开发的，同时也引用了一些优秀的第三方库，主要基于 Docker 的静态镜像。** 🐳  

⚠️ **如果您发现任何侵权内容，请随时与我联系以便删除。** ✉️  

💡 **如果您有任何想法或建议，希望我制作成应用的，请随时留言！** 💬  

🌐 **所有的修改和创建的目的只是为了让中国的用户可以使用各种优秀的应用而不用担心网络导致的无法使用。**  
...
- **文档处理工具**：使用自动化工具进行Markdown文档的智能转换
...
4. 📋 将以下 URL 复制并粘贴到库输入字段中：
   ...
   ```
5. ➕ 点击 **添加**
6. ✅ 该库中的应用现在将在您的应用商店中可用
---

**推荐**: 您也可以点按钮自动添加库：[![添加应用到 Home Assistant](https://img.shields.io/badge/add_addon_repository-MY%20HA-41BDF5?style=for-the-badge&logo=home-assistant&logoColor=white)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https://gitee.com/desmond_GT/hassio-addons) 
