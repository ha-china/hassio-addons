...
1. 将我的 Hass.io 扩展仓库 [repository][repository] 添加到你的 Hass.io 实例中。
1. 安装此扩展。
1. 点击 `保存` 按钮以存储你的配置。
1. 启动扩展。
1. 检查扩展的日志以查看是否一切顺利。
