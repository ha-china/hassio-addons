...
警告：armv7 仅支持到 0.4.3 版本！它将不会在后续版本中更新
...
Mealie 是一个自托管食谱管理和餐计划系统，具有 RestAPI 后端和基于 Vue 的响应式前端应用程序，为整个家庭提供愉悦的用户体验。
这个 Mealie 1.0 的插件基于 hendrix04 的 [docker 镜像](https://hub.docker.com/r/hendrix04/mealie-combined) 的组合。
