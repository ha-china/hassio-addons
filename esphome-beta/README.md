...
该应用允许您编写配置，将微控制器直接转化为智能家居设备，仅需通过 Home Assistant 操作，**无需任何编程经验**。您只需编写 YAML 配置文件；其余工作（空中更新、编译等）均由 ESPHome 自动处理。

<p align="center">
<img title="ESPHome 设备构建器截图" src="https://github.com/esphome/home-assistant-addon/raw/main/esphome-beta/images/screenshot-light.png" width="700px"></img>
</p>

[查阅 ESPHome 文档][website]

## 示例

使用 ESPHome，您可以从寥寥数行 YAML 代码直接生成自定义固件。例如，若要包含一个 [DHT22][dht22] 温度和湿度传感器，您只需在配置文件中包含 8 行 YAML 代码：
...
然后只需点击“上传”，传感器就会“魔法般”地出现在 Home Assistant 中：
