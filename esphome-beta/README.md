...
[![GitHub 星星][github-stars-shield]][存储库]
[![Discord][discord-shield]][Discord]

## 简介

此应用允许您编写配置，无需编程经验即可直接将微控制器转换为通过 Home Assistant 的智能家居设备。
您只需要编写 YAML 配置文件；其余操作（空中更新、编译）均由 ESPHome 处理。
...
在 ESPHome 中，您可以仅仅通过几行 YAML 直接生成定制固件。例如，要包含一个 [DHT22][dht22]
温湿度传感器，您仅需要在配置文件中添加 8 行 YAML：
