...
[![Docker 镜像](https://img.shields.io/badge/docker-3.3.3-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-apache2-minimal-mariadb)
...
这个版本的 Apache Web 服务器在性能和功能之间取得了平衡。它包括 MariaDB 客户端和用于数据库通信的必需 PHP 模块，同时比完整的 Apache2 插件更轻量。推荐用于不需要 Apache 完整模块套件的数据库驱动应用程序。
