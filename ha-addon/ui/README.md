...
此模板提供了一种最小化设置，以在 Vite 中使用热模块替换（HMR）和一些 ESLint 规则使 React 运作。
...
由于对开发和构建性能的影响，此模板中未启用 React 编译器。要添加它，请参阅 [此文档](https://react.dev/learn/react-compiler/installation)。
