...
在端口 8124 上运行 Home Assistant 第二台核心。

这台第二台核心始终在容器内的 8124 端口上监听，无论 Home Assistant 的版本是多少（即使 2026.8 版本因为 Supervisor 的原因将默认端口改为了 80）。

如需在其他端口访问它，请在附加组件的 "网络" (Network) 设置中修改主机端口。

原始 GitHub 地址：https://github.com/Smeagolworms4/ha_second_core
