...
我在业余时间维护这个和其他 Home Assistant 插件：跟进上游更改、Home Assistant 更改以及在真实硬件上进行测试需要花费很多时间（以及一些金钱）。我经常使用大约 5-10 个我 >110 个插件，所以我安装了测试机器（并购买了一些我自己不使用的测试服务，如 vpn）来调试和改进插件。
...
[Sonarr](https://sonarr.tv/) 是一个针对 Usenet 和 BitTorrent 用户的专业电视录制机。它可以监控多个 RSS 源，查找您喜欢的电视节目的新剧集，并将它们下载、分类和重命名。它还可以配置为在更好的质量格式可用时自动升级已下载文件的品质。
...
![图解](https://b0b.fr/wp-content/uploads/2016/02/Sonarr-1-1000x924.jpg)
