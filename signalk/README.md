...
我在业余时间维护这个以及其他 Home Assistant 扩展：跟上上游变化、HA 变化以及在真实硬件上进行测试需要花费很多时间（以及一些金钱）。我经常使用 5-10 个我超过 110 个扩展，所以我安装了测试机器（并购买了些我不用自己测试的服务，如 vpn），以便进行故障排除和改进扩展。

如果这个扩展能为您节省时间或使您的设置更加容易，我将非常感激您的支持！
...
[Signal K 服务器](https://github.com/SignalK/signalk-server) 是一个在船上中央枢纽运行的服务器应用程序。如果您使用或开发海洋电子设备，Signal K 服务器对您来说有一些东西可以提供。
