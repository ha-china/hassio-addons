...
我在业余时间维护这个和其他 Home Assistant 插件：跟踪上游更改、Home Assistant 的更改以及在真实硬件上进行测试都需要花费大量的时间（还有一些钱）。我经常使用大约 5-10 个我的 >110 个插件，所以我安装了测试机器（并购买了一些我自己不使用的测试服务，如 vpn），以进行故障排除和改进插件。

如果这个插件为您节省了时间或使您的设置变得更简单，我会非常感激您的支持！
...
_感谢所有为我的仓库点星的人！要给它点星，请点击下面的图片，然后它就会出现在右上角。谢谢！_
...
[Signal K 服务器](https://github.com/SignalK/signalk-server) 是一个在船上的中心枢纽上运行的服务器应用程序。如果您使用或开发航海电子设备，Signal K 服务器为您提供了很多帮助。
