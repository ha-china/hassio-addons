...
[![Docker 镜像](https://img.shields.io/badge/docker-1.0.5-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-homeassistant-test-instance)
![项目维护](https://img.shields.io/badge/maintainer-FaserF-blue?style=flat-square)

> 一个用于测试目的而创建的独立 Home Assistant Core 实例。
