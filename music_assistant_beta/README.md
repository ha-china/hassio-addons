...
提示：如果您想测试BETA版本同时保留稳定版本，只需停止稳定应用并运行BETA应用。然后，切换回稳定版就简单了，只需再次停止BETA应用并启动稳定应用。两个应用不能同时激活。
...
在Home Assistant内备份音乐助手应用也会包括您的音乐助手数据。请确保在更新到新版本之前始终进行备份，这样您就可以轻松地回滚到上一个版本！
