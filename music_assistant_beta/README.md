...
这是音乐助手的BETA版本。它包含了一些新功能和改进，这些功能在稳定版本发布之前正在接受测试。
...
提示：如果您想测试BETA版本同时保留稳定版本，只需停止稳定应用并运行BETA应用。然后，恢复到稳定版本就像再次停止BETA应用并启动稳定应用一样简单。两个应用不能同时激活。
...
在Home Assistant中备份音乐助手应用也会包括您的音乐助手数据。请确保在更新到新版本之前始终进行备份，这样您就可以轻松地恢复到上一个版本！
