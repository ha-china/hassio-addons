...
这是音乐助手的 **BETA** 版本。它包含了在稳定发布之前进行测试的新功能和改进。
...
作为一名 BETA 测试者，您的反馈至关重要！请报告您遇到的问题：
...
- 版本之间可能会发生数据库迁移
- 性能优化可能仍在进行中
- 您不能从稳定版本迁移到 BETA 版本（反之亦然）

提示：如果您希望在保留稳定版本的同时测试 BETA 版本，只需停止稳定插件并运行 BETA 插件。要恢复到稳定版本，只需再次停止 BETA 插件并启动稳定版本即可。两个插件不能同时激活。
...
在 Home Assistant 中备份音乐助手插件也将包括您的音乐助手数据。请确保在更新到新版本之前始终进行备份，以便您可以轻松地恢复到以前的版本！
...
BETA 发布是稳定发布前的最后测试阶段。您的测试有助于确保所有用户的质量！
