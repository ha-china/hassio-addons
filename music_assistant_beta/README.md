...
作为一名BETA测试者，您的反馈至关重要！请报告您遇到的问题：
...
BETA发布的更新比稳定发布更频繁。通常，每周更新一次或几次。
...
提示：如果您想在保留稳定版本的同时测试BETA版本，只需停止稳定插件并运行BETA插件。然后，回到稳定版本只需再次停止BETA插件并启动稳定版本。两个插件不能同时激活。
...
- 🐛 [报告详细bug](https://github.com/music-assistant/support)
