...
作为一名BETA测试者，你的反馈非常宝贵！请报告你遇到的问题：

### 报告问题前

1. 检查插件的日志（如果需要，可以全局启用`debug`日志或按提供程序级别启用）
...
提示：如果你想在不保留稳定版本的情况下测试BETA版本，只需停止稳定插件并运行BETA插件。然后，要恢复到稳定版本，只需再次停止BETA插件并启动稳定版本。两个插件不能同时激活。
...
BETA发布是稳定发布前的最后测试阶段。你的测试有助于确保所有用户的质量！
