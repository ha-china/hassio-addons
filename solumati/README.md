...
如果您遇到此插件的任何问题，请使用下面的链接报告。问题表单将预填写插件信息，以帮助我们更快地解决问题。
...
**[报告错误](https://github.com/FaserF/hassio-addons/issues/new?template=bug_report.yml&version_integration=2.0.0&log_information=请在此处粘贴插件日志输出%3A%0A%0A)**
