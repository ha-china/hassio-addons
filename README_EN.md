...
🌟 **Welcome to the Home Assistant App repository!** Here, you will find a variety of custom apps. ✨  

🔍 Some apps are developed by me, while others are sourced from excellent third-party libraries, primarily based on static Docker images. 🐳  

If you find any infringing content, please feel free to contact me for removal. ✉️  

If you have any ideas or suggestions for apps you'd like me to create, please feel free to leave a message! 💬  

All modifications and creations are aimed at allowing Chinese users to use various excellent apps without worrying about network accessibility.  
...
**Do not use any VPNs in Mainland China to install these apps.**

All App acceleration correspondence is as follows:
...
- **Document Processing Tool**: Using automated tools for intelligent conversion of Markdown documents
...
**Gitee** [![Add App to Home Assistant](https://my.home-assistant.io/badges/supervisor_add_addon_repository.svg)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https://gitee.com/desmond_GT/hassio-addons) 🚀
