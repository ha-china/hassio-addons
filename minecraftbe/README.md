...
[![@jdeath/homeassistant-addons 的 Star 仓库列表](https://reporoster.com/stars/jdeath/homeassistant-addons)](https://github.com/jdeath/homeassistant-addons/stargazers)
...
你可能想创建一个服务，在深夜重启插件以便更新 Minecraft 版本（见下文）
...
5. 启动插件。
6. 检查插件的日志以查看是否一切顺利。
7. 编辑你希望在 /share/minecraftbe/ 中的任何服务器/权限/白名单属性，并重启插件。注意，你无法在 server.properties 中更改端口，因为它会被某种原因覆盖。然而，你可以在 Home Assistant 的插件配置选项卡中更改端口。我只暴露了 IP4 端口。如果需要 IP6，请告诉我。
