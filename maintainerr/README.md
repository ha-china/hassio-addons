...
_"看起来和Overseerr类似，但功能相反。"_

Maintainerr 是一个基于规则的媒体管理工具，适用于您的 Plex、Jellyfin 或 Emby 生态系统。它根据可配置的规则（观看状态、年龄、评分等）创建智能集合，并可选择删除未观看的内容以保持您的媒体库整洁。
...
持久数据（数据库、配置）存储在 HA 插件配置目录中，并可在插件更新和重新安装后保留。
