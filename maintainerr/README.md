...
Maintainerr 是一个基于规则的媒体管理工具，适用于您的Plex、Jellyfin或Emby生态系统。它可以根据可配置的规则（观看状态、年龄、评分等）创建智能收藏夹，并且可以选择删除未观看的内容，以保持您的媒体库整洁。
...
|------|------|------|
| `UI_PORT` | `6246` | 更改监听端口 |
| `BASE_PATH` | _(空)_ | 在URL子路径下提供服务 |

## 数据

持久数据（数据库、配置）存储在HA扩展配置目录中，并在扩展更新和重新安装后保留。
