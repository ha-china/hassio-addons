...
_"看起来和味道像 Overseerr，但做的是相反的事情。"_

Maintainerr 是一款基于规则的媒体管理工具，适用于您的 Plex、Jellyfin 或 Emby 生态系统。它可以根据可配置的规则（观看状态、年龄、评分等）创建智能收藏夹，并且可以可选地删除未观看的内容，以保持您的媒体库整洁。
...
持久数据（数据库、配置）存储在 HA 扩展配置目录中，并会在扩展更新和重新安装后保留。
