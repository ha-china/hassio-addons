...
[![打开您的 Home Assistant 实例并显示附加组件仪表板。](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=c1e285b7_bash_script_executer)
[![Home Assistant 附加组件](https://img.shields.io/badge/home%20assistant-addon-blue.svg)](https://www.home-assistant.io/addons/)
[![Docker 镜像](https://img.shields.io/badge/docker-2.1.3-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-bashscriptexecuter)
![项目维护](https://img.shields.io/badge/maintainer-FaserF-blue?style=flat-square)

> 在这个 Homeassistant 附加组件环境中执行您自己的 bash 脚本。

---

## 📖 关于

如果您遇到此附加组件的任何问题，请使用下面的链接报告它们。问题表单将预填入附加组件信息，以帮助我们更快地解决问题。
