...
n8n 是一款可扩展的工作流程自动化工具。采用公平的代码分发模式，n8n 总是会有可见的源代码，可以自行托管，并允许您添加自己的自定义函数、逻辑和应用程序。n8n 基于节点的 approach 使其非常灵活，能够让您将任何事物连接到任何事物。
...
您需要自己创建此文件，并将其制作为一个您想要设置的环境的列表，例如：
```
