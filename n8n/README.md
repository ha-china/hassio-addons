...
n8n 是一个可扩展的工作流自动化工具。采用公平的代码分发模式，n8n 将始终拥有可见的源代码，支持自托管，并允许您添加自己的自定义函数、逻辑和应用。n8n 的基于节点的架构使其非常灵活，能够让您将任何事物连接到任何事物。
...
您可以选择设置插件使用环境文件。注意使用 '/home/node' 作为基础路径，它将映射到 /addon_configs/2effc9b9_n8n。
