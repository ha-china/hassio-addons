...
n8n 是一款可扩展的工作流程自动化工具。采用公平的代码分发模式，n8n 将始终拥有可见的源代码，可供自行托管，并允许您添加自己的自定义函数、逻辑和应用程序。n8n 基于节点的架构使其非常灵活，能够让您将任何事物连接到任何事物。

功能未经过测试，但扩展组件可以运行

_感谢每一位为我仓库点星的人！要点星，请点击下面的图片，然后它将显示在右上角。谢谢！_
...
您可以选择将扩展组件设置为使用环境文件。注意使用 '/home/node' 作为基础路径，它将映射到 /addon_configs/2effc9b9_n8n 
