...
n8n 是一款可扩展的工作流自动化工具。采用公平的代码分发模式，n8n 总是会提供可见的源代码，允许您自行托管，并添加您自己的自定义函数、逻辑和应用。n8n 基于节点的架构使其非常灵活，能够让您将任何东西连接到任何东西。
...
您可以选择设置插件使用环境文件。请注意使用 '/home/node' 作为基本路径，它将映射到 /addon_configs/2effc9b9_n8n 
