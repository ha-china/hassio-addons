...
n8n 是一个可扩展的工作流自动化工具。采用公平的代码分发模式，n8n 总是拥有可见的源代码，可供自行托管，并允许您添加自己的自定义函数、逻辑和应用。n8n 基于节点的 Approach 使得其非常灵活，您可以将任何东西连接到任何东西。
...
1. 将我的 Hass.io 扩展组件仓库[仓库](https://github.com/jdeath/homeassistant-addons)添加到您的 Hass.io 实例中。
1. 点击 `保存` 按钮以存储您的配置。
1. 启动插件。
1. 插件会失败，这是正常的
