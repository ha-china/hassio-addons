...
n8n 是一个可扩展的工作流程自动化工具。采用公平的代码分发模式，n8n 总是会提供可见的源代码，允许您自行托管，并允许您添加自己的自定义函数、逻辑和应用程序。n8n 的基于节点的架构使其非常灵活，能够让您将任何事物连接到任何事物。
...
1. 再次启动插件。
1. 检查插件的日志以查看是否一切顺利。
1. 打开 WebUI 应该可以通过 <您的 IP>:端口号 访问。
1. 设置管理员账户。
