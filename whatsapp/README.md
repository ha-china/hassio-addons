...
如果您有新的功能或改进的建议，请使用下面的链接提交功能请求。表单将预填写附加组件信息。
...
**[报告错误](https://github.com/FaserF/hassio-addons/issues/new?template=bug_report.yml&version_integration=0.3.0&log_information=请在此处粘贴附加组件日志输出：%0A%0A)**
