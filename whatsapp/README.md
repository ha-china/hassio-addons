...
[![Docker 镜像](https://img.shields.io/badge/docker-0.5.2-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-whatsapp)
...
> [!NOTE]
> 请使用上面的链接报告问题。这确保了您的错误报告中自动包含所有必要信息（附加组件名称、版本等）。
...
通过 Home Assistant 附加组件页面上的 **配置** 选项卡来配置附加组件。
