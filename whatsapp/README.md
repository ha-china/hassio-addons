...
[![Docker 镜像](https://img.shields.io/badge/docker-1.5.3-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-whatsapp)
...
- `ha-app-status`: 检查健康状态和版本（包含 HA 核心和 OS 信息）。
