...
[![打开您的 Home Assistant 实例并显示插件仪表板。](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=c1e285b7_ShieldDNS)
[![Home Assistant 插件](https://img.shields.io/badge/home%20assistant-addon-blue.svg)](https://www.home-assistant.io/addons/)
[![Docker 镜像](https://img.shields.io/badge/docker-2.2.0-blue.svg?logo=docker&style=flat-square)](https://github.com/FaserF/hassio-addons/pkgs/container/hassio-addons-shielddns)
![项目维护](https://img.shields.io/badge/maintainer-FaserF-blue?style=flat-square)

> 高性能 DoT 代理，适用于 AdGuard Home

---

## 📖 关于

如果您在使用此插件时遇到任何问题，请使用下面的链接报告。问题表单将预填写插件信息，以帮助我们更快地解决问题。
