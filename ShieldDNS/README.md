...
它具有一个高级 **管理仪表板** 用于实时监控，以及一个与 AdGuard、Pi-hole 和 uBlock origin 列表兼容的强大 **过滤引擎**。
...
- **初始设置**：首次访问时，您将被提示设置一个 12 位字符的管理员密码。
...
| **DoH** | `443` | 标准 HTTPS 网页端口。 | **原生**（Windows 11、iOS、浏览器）。 |
