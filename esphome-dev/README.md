...
[![GitHub 星标数][github-stars-shield]][仓库]
[![Discord][discord-shield]][Discord]

## 简介

此应用允许您编写配置，无需编程经验即可直接将微控制器变成支持 Home Assistant 的智能家庭设备。您只需要编写 YAML 配置文件；其余部分（空中更新、编译）均由 ESPHome 自动处理。
...
使用 ESPHome，您可以从几行 YAML 代码直接生成自定义固件。例如，要将 [DHT22][dht22] 温湿度传感器包含在内，您的配置文件只需包含 8 行 YAML：
...
然后只需点击 UPLOAD，传感器便会神奇地出现在 Home Assistant 中：
...
[版本]: https://next.esphome.io/changelog/
