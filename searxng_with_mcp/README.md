...
此 Home Assistant 插件由 https://github.com/DDanii/HA-Add-ons-by-DDanii/tree/master/searxng 适配而来。

它包括一个轻量级的 MCP 服务器，为 llama.cpp（以及任何其他 MCP 兼容客户端）提供了一个通过私有 [SearXNG](https://github.com/searxng/searxng) 实例进行网络搜索的接口。

MCP 服务器由 https://github.com/jdeath/mcp-searxng-enhanced 适配而来，以提供快速 MCP IP 端点（使用人工智能进行了编辑）。有关 MCP 代码，请参阅 `https://github.com/jdeath/mcp-searxng-enhanced`。
