...
它包括一个轻量级的 MCP 服务器，为 llama.cpp（以及任何其他 MCP 兼容的客户端）提供通过私有 [SearXNG](https://github.com/searxng/searxng) 实例的网页搜索。
...
在插件配置文件夹（addon_configs/2effc9b9_searxng_with_mcp）的第一次运行后，将会有一个 custom.sh 文件，您可以在其中添加您自己的命令。
---
