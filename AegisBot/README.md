...
如果您有新的功能或改进的想法，请使用下面的链接提交功能请求。表单将预填插件的详细信息。

## 🐛 报告错误

如果您在使用此插件时遇到任何问题，请使用下面的链接报告它们。问题表单将预填插件的详细信息，以帮助我们更快地解决问题。

**[报告错误](https://github.com/FaserF/hassio-addons/issues/new?template=bug_report.yml&version_integration=0.3.2&log_information=请在此处粘贴插件日志输出：%0A%0A)**
