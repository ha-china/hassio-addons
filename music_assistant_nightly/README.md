...
夜间的 Music Assistant 开发版本。

## ⚠️ 警告 - 仅限高级用户使用 ⚠️

这是一个 Music Assistant 的 **NIGHTLY**（开发）版本。它包含最新的代码更改，并且**不推荐日常使用**。
...
NIGHTLY 版本是从 Music Assistant 的 `dev` 分支自动构建的。它们包括：
...
- 🐛 [通过详细日志报告 Bug](https://github.com/music-assistant/support)
- 🔧 提交带修复的拉取请求
- 📝 记录问题和解决方案
- 💬 在 [Discord](https://discord.gg/PZQ6RWbfeS) 帮助其他 NIGHTLY 用户
- 🧪 测试特定功能

访问 [Music Assistant 组织](https://github.com/music-assistant) 在 GitHub 上贡献。
