...
这是一个 Music Assistant 的 **NIGHTLY**（开发）版本。它包含了最新的代码更改，并且**不推荐日常使用**。
...
- 🐛 [提交详细的日志报告错误](https://github.com/music-assistant/support)
- 🔧 提交包含修复的拉取请求
- 📝 记录问题和解决方案
...
如果你已经读到这一步，仍然想使用 NIGHTLY，你可能就是合适的使用者。欢迎来到前沿开发！ 🚀
