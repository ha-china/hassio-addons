# Music Assistant (NIGHTLY) 扩展

Music Assistant 的尖端开发构建版本。

## ⚠️ 注意 - 仅限高级用户使用 ⚠️

这是一个 Music Assistant 的 **NIGHTLY**（开发）版本。它包含最新的代码更改，并且**不推荐用于日常使用**。
...
- 🐛 [提供详细的日志报告错误](https://github.com/music-assistant/support)
- 🔧 提交包含修复的拉取请求
- 📝 记录问题和解决方案
