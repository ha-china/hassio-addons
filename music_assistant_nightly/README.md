...
Music Assistant 的尖端开发版本。

## ⚠️ 警告 - 仅限高级用户使用 ⚠️

这是 Music Assistant 的一个 **NIGHTLY**（开发）版本。它包含最新的代码更改，并且**不推荐用于日常使用**。
...
NIGHTLY 版本是从 Music Assistant 的 `dev` 分支自动构建的。它们包含：
...
如果你已经读到这一步，并且仍然想使用 NIGHTLY，你可能就是合适的用户。欢迎来到尖端开发！ 🚀
