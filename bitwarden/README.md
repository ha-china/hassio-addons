...
我在业余时间维护这个以及其他 Home Assistant 插件：跟踪上游更改、HA 更改以及在实际硬件上进行测试需要花费大量时间（以及一些金钱）。我经常使用我超过 110 个插件中的 5-10 个，因此我安装了测试机器（并购买了某些我不使用的测试服务，如 vpn），以进行故障排除和改进插件。
...
1. 将我的插件仓库添加到您的 Home Assistant 实例中（在监督器的插件商店顶部右侧，或者如果您已配置我的 HA，请点击下面的按钮）。
