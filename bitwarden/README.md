...
我在业余时间维护这个和其他 Home Assistant 扩展：跟进上游变更、HA 变更以及在真实硬件上进行测试需要花费大量时间（和一些金钱）。我经常使用我超过 110 个扩展中的 5-10 个，因此我安装了测试机器（并购买了某些我自身不使用的测试服务，如 VPN）来调试和改进扩展。
...
_感谢所有为我仓库点星的人！要星标它，请点击下面的图片，然后它就会出现在右上角。谢谢！_
