...
# ⚠️ 建议使用官方插件 (https://github.com/hassio-addons/addon-bitwarden) 而不是这个分支。这个分支的唯一好处是自动发布功能，该功能现在已经实现在官方版本中了。⚠️


我在业余时间维护这个和其他 Home Assistant 插件：跟进上游变更、HA 变更以及在真实硬件上测试需要大量时间（和一些金钱）。我大约使用了 5-10 个我的 >110 个插件，所以我经常安装测试机器（并购买一些我不自己使用的测试服务，如 VPN）来排查故障和改进插件。

如果这个插件为您节省了时间或让您的设置更简单，我将非常感谢您的支持！
