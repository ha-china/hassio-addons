...
![Version](https://img.shields.io/badge/dynamic/yaml?label=版本&query=%24.version&url=https%3A%2F%2Fraw.githubusercontent.com%2Falexbelgium%2Fhassio-addons%2Fmaster%2Fcalibre_web%2Fconfig.yaml)
...
![Arch](https://img.shields.io/badge/dynamic/yaml?color=success&label=架构&query=%24.arch&url=https%3A%2F%2Fraw.githubusercontent.com%2Falexbelgium%2Fhassio-addons%2Fmaster%2Fcalibre_web%2Fconfig.yaml)
...
![下载量趋势](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/calibre_web/stats.png)

## 关于

---

[Calibre-web](https://github.com/janeczku/calibre-web) 是一个提供干净界面的网络应用程序，用于浏览、阅读和下载电子书，使用现有的 Calibre 数据库。还可以通过应用程序本身集成 Google Drive，并通过应用程序编辑元数据和 Calibre 图书馆。

这个插件基于以下 Docker 镜像：https://github.com/linuxserver/docker-calibre-web
...
| `DOCKER_MODS` | 字符串 | | 要应用的 Docker 修改 |
| `OAUTHLIB_RELAX_TOKEN_SCOPE` | 字符串 | | OAuth 令牌作用域放宽 |
| `ingress_user` | 字符串 | | Ingress 认证的用户名 |
