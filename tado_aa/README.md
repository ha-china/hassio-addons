...
[![打开您的 Home Assistant 实例并显示添加项仪表板。](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=c1e285b7_tado_aa)
...
> 用于地理围栏和开窗检测的 Tado Auto-Assist

---

## 📖 关于

如果您在使用此添加项时遇到任何问题，请使用下面的链接进行报告。问题表单将预填写添加项信息，以帮助我们更快地解决问题。
