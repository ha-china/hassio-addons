...
现代化的可定制仪表板，适用于 Home Assistant，具有美丽的玻璃渐变设计。

## 免责声明：
这是一个测试版。如果你有非常自定义的设置，它可能无法正常工作。我不期望它崩溃和烧毁，因为我在我的设置上进行了彻底的测试，但请小心操作并备份你的 Home Assistant！
