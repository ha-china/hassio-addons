...
基于 yt-dlp 分支（使用 yt-dlp）的网页界面，支持播放列表。允许您从 YouTube 和其他数十个网站下载视频（https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md）。
...
4. 启动扩展。
5. 检查扩展的日志以查看是否一切顺利。
6. 打开 WebUI 应该可以通过入口或 <您的 IP>:端口号 访问。
