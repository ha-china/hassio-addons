...
基于 yt-dlp 分支（https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md）的 web GUI，支持播放列表。允许您从 YouTube 和其他数十个网站（https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md）下载视频。
