...
我在业余时间维护这个和其他家居助理插件：跟踪上游变更、家居助理变更以及在实际硬件上进行测试需要花费大量时间（以及一些金钱）。我经常使用我超过110个插件中的5-10个，所以我安装了测试机器（并购买了些我不使用的测试服务，如VPN），用于故障排除和改进插件。
...
_感谢所有给我仓库点星的人！要点星，请点击下面的图片，然后它将显示在右上角。谢谢！_
...
1. 将我的插件仓库添加到您的家居助理实例中（在 supervisor 插件商店的右上角，或点击下面的按钮如果您已经配置了我的HA）
...
| `CODEX_RESET_ADMIN` | 重置管理员用户名和密码为默认值 | - | `1` |
