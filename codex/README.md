# Home Assistant 扩展：Codex

我在业余时间维护这个以及其他 Home Assistant 扩展：跟进上游更改、Home Assistant 更改以及在实际硬件上进行测试都需要花费大量的时间（以及一些金钱）。我经常使用大约 5-10 个我超过 110 个扩展中的几个，所以我安装了测试机器（并购买了一些我自己不使用的测试服务，如 VPN）来调试和改进扩展。
...
[Codex](https://github.com/ajslater/codex) 是一个基于 Web 的漫画档案浏览器和阅读器
这个扩展基于官方的 Docker 镜像：https://hub.docker.com/r/ajslater/codex
...
- **env_vars 选项**：使用扩展 `env_vars` 选项传递额外的环境变量（名称为大写或小写）。请参阅 https://github.com/alexbelgium/hassio-addons/wiki/Add-Environment-variables-to-your-Addon-2 获取详细信息。
