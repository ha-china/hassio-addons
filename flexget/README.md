...
我在业余时间维护这个和其他 Home Assistant 插件：跟进上游变化、Home Assistant 变化以及在真实硬件上进行测试都需要花费很多时间（还有一些钱）。我经常使用我超过 110 个插件中的 5-10 个，所以我安装了测试机器（并购买了如 vpn 等一些我自身不使用的测试服务）来调试和改进插件。
...
[FlexGet](https://flexget.com/) 是一个多功能的媒体自动化工具，适用于您的所有媒体。它可以支持种子、NZBs、播客、漫画、电视、电影、RSS、HTML、CSV 等。
...
1. 将我的插件仓库添加到您的 Home Assistant 实例中（在右上角的监督器插件商店中，或点击下面的按钮如果您已经配置了我的 HA）
