...
我在业余时间维护这个以及其他 Home Assistant 插件：跟踪上游更改、HA 更改以及在真实硬件上进行测试需要花费很多时间（以及一些金钱）。我经常使用大约 5-10 个我超过 110 个插件中的部分，所以我安装了测试机器（并购买了一些我本人不使用的测试服务，例如 VPN），以便进行故障排除和改进插件。
...
[FlexGet](https://flexget.com/) 是一个多功能的媒体自动化工具。它可以支持种子、NZB、播客、漫画、电视、电影、RSS、HTML、CSV 等等。
