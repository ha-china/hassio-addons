...
我在业余时间维护这个和其他 Home Assistant 扩展：跟进上游变化、Home Assistant 的变化以及在真实硬件上进行测试都需要花费大量的时间（以及一些金钱）。我经常使用我 >110 个扩展中的 5-10 个，所以我安装了测试机器（并购买了如 vpn 等一些我不使用的测试服务），以便进行故障排除和改进扩展。
...
_感谢所有星标我的仓库的人！要星标，请点击下面的图片，然后它将显示在右上角。谢谢！_
...
[FlexGet](https://flexget.com/) 是一个多功能的自动化工具，适用于您所有的媒体。它可以支持种子、NZB、播客、漫画、电视、电影、RSS、HTML、CSV 等等。
...
默认密码：`homeassistant123`（通过扩展选项进行更改）。
