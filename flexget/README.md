...
我在业余时间维护这个和其他 Home Assistant 扩展：跟踪上游变更、Home Assistant 变更以及在真实硬件上进行测试需要花费大量的时间（以及一些金钱）。我经常使用我超过 110 个扩展中的 5-10 个，所以我安装了测试机器（并购买了一些我不使用的测试服务，例如 VPN），以便进行故障排除和改进扩展。

如果这个扩展为您节省了时间或使您的设置更简单，我将非常感谢您的支持！
...
[FlexGet](https://flexget.com/) 是一个多功能的媒体自动化工具，适用于您所有的媒体。它可以支持种子、NZB、播客、漫画、电视、电影、RSS、HTML、CSV 等。
