...
我在业余时间维护这个以及其他 Home Assistant 插件：跟踪上游变更、Home Assistant 变更以及在真实硬件上进行测试需要花费很多时间（也有些费用）。我经常使用我 >110 个插件中的 5-10 个，所以我安装了测试机器（并购买了如 vpn 等一些我不自己使用的测试服务），以排查问题和改进插件。
