...
我利用业余时间维护这个和其他 Home Assistant 插件：跟上上游的变化、HA 的变化，以及在真实硬件上测试都需要很多时间（和一些钱）。我大约使用了我 >110 个插件中的 5-10 个，所以我安装了一些我不自己使用的测试机器（和购买了一些测试服务，如 VPN）来调试和提高插件。
...
_感谢所有给我的仓库点赞的人！点击下面的图片来点赞，它将在右上角。谢谢！_
...
[FlexGet](https://flexget.com/) 是一个多功能的自动化工具，适用于所有你的媒体。它可以支持种子、NZB、播客、漫画、电视、电影、RSS、HTML、CSV 等。
