...
我在业余时间维护这个以及其他 Home Assistant 扩展：跟踪上游更改、HA 更改以及在真实硬件上进行测试需要花费大量时间（还有一些钱）。我经常使用大约 5-10 个我的 >110 个扩展，所以我安装了测试机器（并购买了如 VPN 这样的测试服务），这些服务我自己并不使用，以便排查问题和改进扩展。

如果这个扩展节省了你的时间或使你的设置变得更简单，我将非常感激你的支持！
...
[FlexGet](https://flexget.com/) 是一款适用于所有媒体的多用途自动化工具。它可以支持种子、NZBs、播客、漫画、电视、电影、RSS、HTML、CSV 等等。
...
默认密码：`homeassistant123`（通过扩展选项更改）。
