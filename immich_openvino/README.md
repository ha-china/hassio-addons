...
_感谢所有将我的仓库标记为星标的人！要将其标记为星标，请点击下面的图片，然后它将在右上角显示。谢谢！_
...
从您的手机直接进行自我托管照片和视频备份解决方案，支持 OpenVINO 硬件加速。这是 Immich 的 OpenVINO 启用版本，它为使用 Intel GPU 和 CPU 执行机器学习任务提供了硬件加速。
...
在 github 上创建问题，或在 [home assistant 讨论](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 中提问
