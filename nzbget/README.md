...
我在业余时间维护这个以及其他 Home Assistant 扩展：跟进上游更改、HA 更改以及在实际硬件上进行测试都需要花费大量的时间和一些金钱。我经常使用 5-10 个我的 >110 个扩展，所以我安装了测试机器（并购买了某些我自己不使用的测试服务，例如 VPN）来调试和改进扩展。
...
_感谢所有为我的仓库加星的人！要加星，请点击下面的图片，然后它就会出现在右上角。谢谢！_
...
[nzbget](http://nzbget.net/) 是一个新闻组下载器，用 C++ 编写，旨在通过使用最少的系统资源来实现最大下载速度。
此扩展基于 docker 镜像 https://github.com/linuxserver/docker-nzbget
